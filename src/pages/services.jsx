  ...
  return (
    ...
    <div>
     ...
     <div className='bg-white text-center flex flex-col items-center p-10'>
      ...
      <p className='md:w-128 sm:96'>{lang ? "There’s a process involved in creating your Technical Support solutions to meet your business goals. That process involves getting to know your business and what you want to accomplish and delivering the best solutions that fit your needs." : 'هناك عملية متضمنة في إنشاء حلول الدعم الفني للتأكد من أننا نلبي أهداف عملك. تتضمن هذه العملية التعرف على عملك ، وما تريد تحقيقه ، ثم تقديم أفضل الحلول التي تناسب احتياجاتك.'}</p>
     </div>
